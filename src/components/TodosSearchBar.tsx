...
export const TodosSearchBar = () => {
  ...
  return (
    <div className={cn("flex w-80 pb-4 pt-6 md:w-96", isServer ? "cursor-not-allowed" : "")}>
      ...
      <div className="relative flex w-full rounded-e-lg border border-s-0 border-gray-300 border-s-gray-50 dark:border-gray-600 dark:border-s-gray-700 dark:bg-slate-800">
        ...
        <input
          type="search"
          className="block w-full rounded-e-lg py-2.5 pr-4 text-sm text-gray-900 outline-none disabled:cursor-not-allowed dark:bg-slate-800 dark:text-white dark:placeholder:text-gray-400"
          placeholder="Search..."
